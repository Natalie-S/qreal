...
QString ValuesSerializer::serializeQVariant(QVariant const &v)
{
    switch (v.type()) {
    case QVariant::Int:
        return /*"int|" + */QString::number(v.toInt());
    case QVariant::UInt:
        return /*"uint|" + */QString::number(v.toUInt());
    case QVariant::Double:
        return /*"double|" + */QString::number(v.toDouble());
    case QVariant::Bool:
        return /*"bool|" + */QString("%1").arg(v.toBool());
    case QVariant::String:
        return /*"QString|" + */v.toString();
    case QVariant::StringList:
        return /*"QStringList|" + */v.toStringList().join(',');
    case QVariant::Char:
        return /*"char|" + */v.toChar();
    case QVariant::PointF:
        return /*"QPointF|" + */serializeQPointF(v.toPointF());
    case QVariant::Polygon:
        return /*"QPolygon|" + */serializeQPolygonF(v.value<QPolygon>());
    case QVariant::PolygonF:
        return /*"QPolygonF|" + */serializeQPolygonF(v.value<QPolygonF>());
    case QVariant::UserType:
        if (v.userType() == QMetaType::type("qReal::Id")) {
            return /*"qReal::Id|" + */v.value<qReal::Id>().toString();
        }
    default:
        // something bad
